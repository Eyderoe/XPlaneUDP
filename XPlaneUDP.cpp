 ...
 * @return 智能指针包含的数组
 */
std::shared_ptr<std::array<char, 1472>> BufferPool::getBuffer () {
 ...
 * @param freq 频率
 */
void XPlaneUdp::changeDatarefFreq (const DatarefIndex &dataref, const int32_t freq) {
...
asio::awaitable<void> XPlaneUdp::flushQueue () {
    while (true) {
